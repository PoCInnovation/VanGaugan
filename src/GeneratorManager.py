...
class GeneratorManager():
    def __init__(self):
        self.generators = {
            GType.CELEBA_30_E.value: loadModel("models/celeba_30_g", DCGenerator),
            GType.CELEBA_20_E.value: loadModel("models/2020-06-25_g_20", DCGenerator),
            GType.CELEBA_10_E.value: loadModel("models/2020-06-25_g_10", DCGenerator)
        }
